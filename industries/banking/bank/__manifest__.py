...
{
    'name': 'Financial Institution Applucation',
    'version': '1.0.1',
    'category': 'Accounting/Financial Institution',
    'sequence': 40,
    'summary': 'An app that uses odoo to manage all the operations of a financial institution',
    'description': "",
    ...
    'website': 'https://thegleam.tech/page/financial-institution-app',
}
