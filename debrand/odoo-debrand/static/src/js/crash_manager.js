odoo.define('web.ErrorDialogRegistry', function (require) {
    ...
    var CrashManager = AbstractService.extend({
        ...
        rpc_error: function(error) {
            ...
            // System custom exception: UserError, AccessError, ...
    ...
    */
    ...
    var RedirectWarningHandler = Widget.extend(ExceptionHandler, {
        ...
        display: function() {
            ...
            new WarningDialog(this, {
                title: _.str.capitalize(error.type) || _t("System Warning"),
                buttons: [
    ...
    function session_expired(cm) {
        return {
            display: function () {
                const notif = {
                    type: _t("System Session Expired"),
                    message: _t("Your system session expired. The current page is about to be refreshed."),
                };
                const options = {
                    buttons: [{
                        text: _t("Ok"),
