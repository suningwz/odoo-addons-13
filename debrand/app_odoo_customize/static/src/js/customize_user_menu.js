odoo.define('app_odoo_customize.UserMenu', function (require) {
    ...
    //避免错误，要再定义
    var documentation_url = 'https://thegleam.tech';
    var documentation_dev_url = 'https://thegleam.tech';
    var support_url = 'https://thegleam.tech';
    var account_title = 'My Account';
    var account_url = 'https://thegleam.tech';
